...
// I will just use regex to clean up any duplicate or malformed PaymentList
// Let's first remove from the first FormattedAmountInput to DiscountListProps
